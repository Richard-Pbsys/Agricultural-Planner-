...
namespace VHS.Data.Migrations
{
    ...
    [Migration("20250228082552_LightningWateringModelsUpdates")]
    partial class LightningWateringModelsUpdates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VHS.Data.Models.Produce.LightZone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VHS.Data.Models.Produce.RecipeWaterSchedule", b =>
                {
                    ...
                    b.ToTable("RecipeWaterSchedule");
                });

            modelBuilder.Entity("VHS.Data.Models.Produce.WaterZone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VHS.Data.Models.Produce.WaterZoneSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VHS.Data.Models.Produce.LightZoneSchedule", b =>
                {
                    b.HasOne("VHS.Data.Models.Produce.LightZone", "LightZone")
                        .WithMany()
            ...
            modelBuilder.Entity("VHS.Data.Models.Produce.RecipeLightSchedule", b =>
                {
                    b.HasOne("VHS.Data.Models.Produce.LightZoneSchedule", "LightZoneSchedule")
                        .WithMany()
            ...
            modelBuilder.Entity("VHS.Data.Models.Produce.RecipeWaterSchedule", b =>
                {
                    ...
                    b.HasOne("VHS.Data.Models.Produce.WaterZoneSchedule", "WaterZoneSchedule")
                        .WithMany()
            ...
            modelBuilder.Entity("VHS.Data.Models.Produce.WaterZoneSchedule", b =>
                {
                    b.HasOne("VHS.Data.Models.Produce.WaterZone", "WaterZone")
                        .WithMany()
